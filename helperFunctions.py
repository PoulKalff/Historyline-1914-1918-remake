...
unitsParameters = 	{	'' 				:	None,
						'infantryG' 	:	{	'name'		: 'Infantry',
												...
												'movement'	: 3,
												'sight'		: 3,
												'weapons'	: ['gewehr98', 'reichsrevolver', 'bayonet' , None],
...
weaponsParameters = 	{	'gewehr98' :		{	'name'		: 'Gewehr 98',
													'air'		: [150, 1],
													'ground' 	: [430, 1],
													'water'		: [430, 1],
													'ammo'		: 3,
							...
							'reichsrevolver' :	{	'name'		: 'Reichsrevolver',
													'air'		: [100, 1],
													'ground' 	: [250, 1],
													'water'		: None,
													'ammo'		: 5,
													'picture'	: pygame.image.load('gfx/weapons/revolverM1879.png'), 
												},
