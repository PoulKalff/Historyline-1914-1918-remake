...
infraIcons =    {   '<none>'	:	None,
					...
					'rail236'   :   pygame.image.load('gfx/infrastructure/rail236.png'),
					...
					'rBridge14' :   pygame.image.load('gfx/infrastructure/roadBridge14.png'),
					'rBridge25' :   pygame.image.load('gfx/infrastructure/roadBridge25.png'),
					'rBridge36' :   pygame.image.load('gfx/infrastructure/roadBridge36.png')
				}


unitsParameters =   {   '<none>'		:		 None,
						...
						'CP_trainArt' :		{   'name'          : 'Train Artillery',
												'country'       : 'Germany',
												'armour'        : 75,
												'speed'         : 7,
												'weight'        : 7,
												...
												'movementType'  : 1,	# Only move on tracks
												'weapons'       : ['lefh', None, None, None],
												'icon'          : pygame.image.load('gfx/units/icons/trainArtillery.png'),
												'picture'       : pygame.image.load('gfx/units/pictures/trainArtillery.png')
											},
						'EC_trainArt' :		{   'name'          : 'Train Artillery',
												'country'       : 'France',
												'armour'        : 75,
												'speed'         : 7,
												'weight'        : 7,
						...
						'CP_sappers' :		{   'name'          : 'Sappers',
												...
												'movementType'  : 0,
												'weapons'       : [None, None, None, None],
												'icon'          : pygame.image.load('gfx/units/icons/sappers.png'),
												'picture'       : pygame.image.load('gfx/units/pictures/sappers.png')
											},
						'EC_sappers' :		{   'name'          : 'Sappers',
												'country'       : 'France',
												'armour'        : 75,
												'speed'         : 7,
												'weight'        : 7,
